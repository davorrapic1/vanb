...
public class HnbController : ControllerBase
{
    ...
    public async Task<ActionResult> GetHnbData ()
    {
        ...
        try
        {
            HttpResponseMessage response = await client.GetAsync ("https://api.hnb.hr/tecajn/v2?datum-primjene-od=2022-5-3&datum-primjene-do=2022-6-1&valuta=EUR&valuta=USD&format=xml");
